...
> Evaluated on the **TensorFlow User Guide** (9 questions) using an **LLM-as-Judge** framework with `llama-3.1-8b-instant` — no ground-truth labels required.
...
| 🔍 **Context Precision** | **0.59** | 🟠 Good |

### 🏆 Overall RAG Score: `0.75 / 1.0`

</div>

**What these numbers mean:**
- **Faithfulness (0.82)** — 82% of generated answers are fully grounded in retrieved context, with no hallucinated content
- **Answer Correctness (0.81)** — Answers are factually correct and directly address what was asked
- **Context Recall (0.80)** — The retrieval pipeline surfaces the right source chunks 80% of the time
- **Context Precision (0.59)** — Active area of improvement; some retrieved chunks contain noise alongside relevant content. Planned fix: tighter reranking threshold
